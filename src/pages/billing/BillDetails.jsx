...
const BillDetails = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {/* Invoice */}
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden print:border-0 print:shadow-none">
        {/* Invoice Header */}
